...
def nn_model (x_input , W1, b1, W2, b2):
    x_input= tf.reshape(x_input, (x_input.shape[0],-1))         #Flattern from [batchsize x 28x28] -> [batchsize x 784]
    x=tf.add(tf.matmul(tf.cast(x_input , tf.float32), W1), b1)  #Cast the input into a tensor float and multiply
